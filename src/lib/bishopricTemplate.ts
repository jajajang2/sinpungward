...
export const BISHOPRIC_TEMPLATE: Block[] = [
  ...
  h(3, "1. 경전, 교회 지도자 및 본 지침서의 가르침 검토 (5분씩 진행)"),
  li("담당: "),

  h(3, "2. 와드에서 행하는 하나님의 구원 및 승영 사업 조율"),
  p("01) 성찬식 모임 준비", true),
  li("사회: "),
  p("〔와드 행사〕", true),
  li("지지: "),
  ...
  h(3, "3. 청소년과 어린이를 중심으로 한 와드 내의 개인 및 가족 강화"),
  li("a. 초등회: "),
  li("b. 청소년: "),
  li("c. 독신: "),
  li("d. 회원동정(방문): "),

  h(3, "4. 신권 의식을 비롯한 의식을 받도록 준비할 수 있는 회원 파악"),
  li("1) 신권 승진 · 수련장로 준비: "),
  li("2) 성전추천서 접견 (3개월):", [
    li("접견자: "),
    li("만료 예정자 (3개월 내): "),
  ...
  h(3, "6. 그 외 의제 (조직·프로그램, 예산, 임무 지명 보고서 등)"),
  p("〔기타 의제〕", true),
  li(""),
  p("〔월별 계획〕", true),
  li(""),
